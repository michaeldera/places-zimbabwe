    ...
    public static class Main 
    {
            ...
            ILogger log)
        {
            ...
            if ("Bulawayo".Equals(city, StringComparison.OrdinalIgnoreCase)){
                var highDensity = new List<string>(highDensitySuburbs);
                var lowDensity = new List<string>(lowAndMediumDensitySuburbs);
